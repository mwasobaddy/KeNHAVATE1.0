<?php
    ...
    include("../admin/auth_controller/functionalities.php");
...
<head>
    ...
    <title>Subject Matter Expert Dashboard</title>
    ...
    <link rel="stylesheet" href="admin/resources/sme.css">
...
<body style="display: flex;">
    ...
    <?php include '../admin/resources/sme_landing_sidebar.php'; ?>
    
    <?php include '../admin/resources/sme_landing_maincontent.php'; ?> 
    ...
    <script src="admin/resources/sme.js"></script>
    <script src="admin/resources/sme_landing.js"></script>
</body>
</html>